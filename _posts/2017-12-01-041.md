...
mBeing able to create a virtual system that does not depend on hardware is a very interesting thing but what is the point, why would someone use it. There are two very different reasons that justify making use of VMs 
...
There are plenty of companies that do that. _(check _ **_Outsourcing_** _ bellow) _ They offer VMs that are accessible online and are cheap to run, you pay them for the hour. 
